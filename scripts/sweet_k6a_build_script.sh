...
clang() {
    ...
    echo "Cloning clang"
    if [ ! -d "clang" ]; then
        git clone -q https://github.com/Lafactorial/android_prebuilts_clang_host_linux-x86_clang-r510928.git --depth=1 -b 14 clang
...
CODENAME="sweet_k6a"
export CODENAME
DEFCONFIG="vendor/sweetk6a.config" "vendor/sdmsteppe-perf_defconfig"
export DEFCONFIG
